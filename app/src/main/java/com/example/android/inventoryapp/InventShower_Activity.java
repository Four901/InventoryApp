...
public class InventShower_Activity extends AppCompatActivity implements
        LoaderManager.LoaderCallbacks<Cursor> {

    /** Identifier for the pet data loader */
    private static final int EXISTING_INVENT_LOADER = 0;
    private String LOG_TAG=InventShower_Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inventshower_acitvity);


        Intent intent=getIntent();
        Uri currentInventUri=intent.getData();
        Log.d(LOG_TAG, "Inside the show "+currentInventUri);
        ...
        nameTextView=(TextView) findViewById(R.id.show_nameID);
        imageView=(ImageView) findViewById(R.id.show_imageId);
         priceView=(TextView) findViewById(R.id.show_priceId);
        quantityView=(TextView) findViewById(R.id.show_quantityId);

        Button backButton=(Button)findViewById(R.id.back_btn_id);
        Button editButton=(Button)findViewById(R.id.edit_btn_id);
        Button deleteButton=(Button)findViewById(R.id.show_deleteId);
        ...
        editButton.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
             Intent intent=new Intent(InventShower_Activity.this,InventoryeditActivity.class);
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        imageView.setImageResource(R.drawable.ic_empty_shelter); // Select "Unknown" gender
    }
