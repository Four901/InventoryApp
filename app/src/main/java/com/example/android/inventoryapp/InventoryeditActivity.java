...
public class InventoryeditActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.invent_edit);
        ...
        mNameEditText = (EditText) findViewById(R.id.edit_invent_name);
        mPriceEditText = (EditText) findViewById(R.id.edit_invent_price);
        mQuantityEditText = (EditText) findViewById(R.id.edit_invent_quantity);
    ...
    private void savePet() {
        ...
        values.put(InventEntry.INVENTAPP_NAME_COLUMN, nameString);
        values.put(InventEntry.INVENTAPP_PRICE_COLUMN, Integer.valueOf(PriceString));
        values.put(InventEntry.INVENTAPP_QUANTITY_COLUMN, Integer.valueOf(QuantityString));
